...
TOKEN_PATH = os.environ.get('TOKEN_PATH', '/home/com-028/gdrive-mcp-setup/token.json')
CREDENTIALS_PATH = os.environ.get('CREDENTIALS_PATH', '/home/com-028/gdrive-mcp-setup/credentials.json')
